...
Private Sub btnSave_Click()
    ...
    sqlstr = "UPDATE tblPools SET poolName = ? "
        ...
        sqlstr = sqlstr & ", prizePercentageFirst=?"
        sqlstr = sqlstr & ", prizePercentageSecond=?"
        sqlstr = sqlstr & ", prizePercentageThird=?"
        sqlstr = sqlstr & ", prizePercentageFourth=?"
...
'        sqlstr = sqlstr & ", prizePercentageFirst=" & val(float(Me.txtPercentage(0))) * 100
'        sqlstr = sqlstr & ", prizePercentageSecond=" & val(float(Me.txtPercentage(1))) * 100
'        sqlstr = sqlstr & ", prizePercentageThird=" & val(float(Me.txtPercentage(2))) * 100
'        sqlstr = sqlstr & ", prizePercentageFourth=" & val(float(Me.txtPercentage(3))) * 100
...
'    'prizes
    ...
    Me.UpDnPerc(0) = rs!prizePercentageFirst
    Me.UpDnPerc(1) = rs!prizePercentageSecond
    Me.UpDnPerc(2) = rs!prizePercentageThird
    Me.UpDnPerc(3) = rs!prizePercentageFourth
