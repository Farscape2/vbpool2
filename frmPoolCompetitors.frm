...
Begin VB.Form frmPoolCompetitors 
   BackColor       =   &H00008000&
   ClientHeight    =   10695
   ClientLeft      =   3555
   ClientTop       =   2475
   ...
   Begin VB.Frame frmGrp 
      ...
      Begin VB.Frame frmGroep 
         ...
         Begin MSDataListLib.DataCombo groep 
            Bindings        =   "frmPoolCompetitors.frx":0000
            DataField       =   "pos1"
         ...
         End
         Begin MSDataListLib.DataCombo groep 
            Bindings        =   "frmPoolCompetitors.frx":0024
            DataField       =   "pos2"
            DataSource      =   "dtaVoorspGroepStnd"
            Height          =   315
            Index           =   1
         ...
         End
         Begin MSDataListLib.DataCombo groep 
            Bindings        =   "frmPoolCompetitors.frx":003E
            DataField       =   "pos3"
            DataSource      =   "dtaVoorspGroepStnd"
            Height          =   315
            Index           =   2
         ...
         End
         Begin MSDataListLib.DataCombo groep 
            Bindings        =   "frmPoolCompetitors.frx":0058
            DataField       =   "pos4"
            DataSource      =   "dtaVoorspGroepStnd"
            Height          =   315
            Index           =   3
   ...
   Begin VB.Frame frmTS 
      ...
      Begin MSDataListLib.DataCombo cmbTS 
         Bindings        =   "frmPoolCompetitors.frx":0072
      ...
      End
      Begin MSDataListLib.DataCombo cmbTS 
         Bindings        =   "frmPoolCompetitors.frx":008B
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   1
         Left            =   480
      ...
      End
      Begin MSDataListLib.DataCombo cmbTS 
         Bindings        =   "frmPoolCompetitors.frx":00A4
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   2
         Left            =   480
   ...
   Begin VB.Frame frmEindstand 
      ...
      Begin MSDataListLib.DataCombo eind 
         Bindings        =   "frmPoolCompetitors.frx":00BD
         DataField       =   "kampioen"
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   0
      ...
      End
      Begin MSDataListLib.DataCombo eind 
         Bindings        =   "frmPoolCompetitors.frx":00D4
         DataField       =   "pltwee"
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   1
      ...
      End
      Begin MSDataListLib.DataCombo eind 
         Bindings        =   "frmPoolCompetitors.frx":00EB
         DataField       =   "plDrie"
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   2
      ...
      End
      Begin MSDataListLib.DataCombo eind 
         Bindings        =   "frmPoolCompetitors.frx":0102
         DataField       =   "plVier"
         DataSource      =   "dtaDezeDeelnemer"
         Height          =   315
         Index           =   3
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataListLib.DataCombo cmbDeelnems 
         Bindings        =   "frmPoolCompetitors.frx":0119
         Height          =   315
         Left            =   1080
         TabIndex        =   113
         Top             =   120
      ...
      Begin MSDataListLib.DataCombo cmbAdressen 
         Bindings        =   "frmPoolCompetitors.frx":0133
         Height          =   315
         Left            =   6960
         TabIndex        =   112
         Top             =   120
   ...
   Begin VB.Frame frmUitslagen 
      ...
      Begin MSDataGridLib.DataGrid grdDeelnWeds 
         Bindings        =   "frmPoolCompetitors.frx":014D
         Height          =   8415
         Left            =   120
         TabIndex        =   22
         Top             =   360
   ...
   End
End
Attribute VB_Name = "frmPoolCompetitors"
